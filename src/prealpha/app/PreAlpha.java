 ...
 */
public final class PreAlpha extends AbstractGame implements Runnable {
    private static final Logger logger = Logger.getLogger(PreAlpha.class
            .getName());
    ...
    public PreAlpha() {
        this(GameType.GRAPHICAL, null);
    }

    public PreAlpha(GameType type) {
        this(type, null);
    }

    public PreAlpha(GameType type, GameSettings settings) {
        this(type, settings, null);
    }
    ...
    public PreAlpha(GameType type, GameSettings settings, UncaughtExceptionHandler exceptionHandler) {
        this.gameName = "Super Ascio PreAlpha";
        this.type = type;
...
class DefaultUncaughtExceptionHandler implements UncaughtExceptionHandler {
    ...
    private PreAlpha game;

    public DefaultUncaughtExceptionHandler(PreAlpha game) {
        this.game = game;
    }
